  ...
  return (
    <div className="absolute inset-0 flex flex-col">
      ...
      <div className="grid flex-shrink-0 grid-cols-[1fr_auto] items-center gap-3 border-b border-border p-4">
        <h2 className="text-lg font-semibold tracking-tight">All Chats</h2>
                    ...
                    {groupThreads.map((thread) => (
                      ...
                      >
                        ...
                        >
                          <div className="min-w-0 flex-1 pr-8">
                            ...
                            <div className="mb-1 flex items-start gap-2">
                              <h3 className="flex-1 text-sm font-semibold leading-tight break-words line-clamp-2">
                                {thread.title}
                              </h3>
                        ...
                        <button
                          ...
                          className={cn(
                            "absolute right-2 top-1/2 -translate-y-1/2 rounded-md p-1.5 opacity-0 transition-opacity duration-200",
